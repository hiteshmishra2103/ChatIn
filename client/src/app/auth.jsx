    ...
    = () => {
        ...
        const signUpFunc = async (event) => {
            ...
            try {
                ...
                const res = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_HOST}:8081/auth/signup`, {
                    username: username,
                    password: password
                },
                    {
        ...
        const loginFunc = async (event) => {
            ...
            try {
                const res = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_HOST}:8081/auth/login`, {
                    username: username,
                    password: password
                },
                    {
